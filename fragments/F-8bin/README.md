...
Date implications: Lateran IV c. 21 (1215) and the viaticum indulgence legislation (Honorius III, 1219; diocesan statutes of the 1220s-1230s) are versified, so the poem is post-c.1220; "sicut Germania servat" implies an author writing outside Germany (Lorraine/Burgundy/Northern France would fit the catalogue's "Eastern France"). The 15th-c. cursive on paper is consistent with the catalogue. Nothing contradicts it.
...
servat". Poem is unprinted; next step is Walther, Initia carminum, by incipit of each dieta, not full text.
