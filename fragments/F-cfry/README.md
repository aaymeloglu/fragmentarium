...
The [image-only response](https://github.com/aaymeloglu/fragmentarium/blob/main/fragments/F-cfry/readings/review-2026-09-22-image-only.json) preserves eight physical lines, the last clipped. It independently reads *esse homo non angelus*, *cum familiaritate*, *Omnis namque pontifex ex*, and much of the dignity/office explanation. Uncertain expansions and clipped ends remain in that record.

Selected assisted comparison text, upper crop lines 3–8. This is normalized text with expanded abbreviations, not a letter-by-letter transcription:

> hoc est quod dicit apostolus. Omnis namque pontifex ex / hominibus … de numero hominum debet esse. Verumtamen licet sit si- / milis aliis in natura tamen debet eos excedere in gradu / dignitatis et in vita. Ideo … assumptus … / hominum super alios elevatus. Et quia non debet querere / proprium commodum vel honorem …

Slashes preserve represented physical divisions; ellipses omit uncertain or unchecked words. Expansions are proposed with the edition available. For comparison, the preserved image-only response records *qd̄ (quod)*, *apl̄s? (apostolus?)*, *namqꝫ (namque)*, *nūo (numero?)*, *hom̄ (hominum?)* and *tn̄ (tamen?)*. These approximate signs and their uncertainty remain in that record. The normalized quotation does not resolve every abbreviation boundary or certify all its expanded letters; it must not be treated as diplomatic evidence. The biblical lemma is common evidence; the connected explanation of nature, dignity, elevation and the office-holder's proper aim carries the comparison.
