# F-0kql — Leuven, Archief van de Abdij van Park, VIIIB20/51
...
## Images and reading scope

The manifest labels image 0073 as [1]v and 0075 as [2]v. Those image numbers, rather than a reconstructed leaf order, locate the readings here. Cached crops `c1_a1.jpg` (0073, left column, upper half) and `k3b.jpg` (0075, right column) were viewed at their stored resolution. Their precise original crop coordinates and any earlier rescaling were not recovered; they are not certified native-scale captures. The neutral packet is a smaller cut from the first crop, with image hashes in the preserved record.

Numbers below count physical lines from the top of each displayed column. Parentheses propose expansions; brackets mark missing or uncertain material, not words silently supplied from an edition. No definite scribal deletion was established in these excerpts. At 0073 line 16 a small interlinear word appears to be *sicut*, above an apparent *sic*; its relationship to the main line remains uncertain and is not flattened into the quotation.

### Image 0073, left column, lines 1–9

```text
1 [S(ed)? / Et?] cum vellet transire fluvium Eufra-
2 tem. ubi modica erat aqua. mule q(ue)
3 erant ligate ad currum fixerunt gra-
4 dum. et cum diu agitarentur a [illegible]
5 transmeare non poterant. Revelatum [illegible]
6 itaq(ue) b(ea)to Gregorio p(er) angelum. ut i[bi?]
7 eccl(esi)am (con)strueret. et s(an)c(t)or(um) reliquias colloca-
8 ret. Quod et factum est. Misit q(ue?) exin[de?] mil[ites?]
...
```text
6 [et? o]mni(?) p(o)p(u)lo ip(s)e venit ad fluvium Eufra-
7 [ten?]. in quo baptizavit eos in nomine patris
8 [et?] filii et sp(iritu)s s(an)c(t)i. Et factum est in magnum mira-
9 [cu]lum. Et [cum?] fluvius stetit et traxit
10 [und]as in sinum suum. et non fluebat. et s(an)c(tu)s
11 Gregorius stabat erectus sup(er) aquas siccis pedi-
...
All loci below are in the [electronic transcription of the 30 September entries](https://www.heiligenlexikon.de/ActaSanctorum/30.September.html). Search within that page for the numbered paragraph and distinctive phrase; the index's `idref` chapter links did not resolve reliably.

| Manuscript passage | Edition passage actually examined | Result |
|---|---|---|
| 0073 a1–9: shallow water, mules attached to a cart stopping, angel, church and relics | Longer life, §142: *albi muli, qui currum trahebant, defecerunt*; the angel requests the saints' dwelling there | Sustained episode sequence, but different Latin. The edition places the crossing in a small valley three stadia from the Euphrates; the manuscript explicitly names the river. |
| 0073 a9–15: three altars, unsuccessful approach to the temple, deception by demons | Longer life, §§142–143: men cannot find the temple gates; the saint's sign and wind destroy the altars | Further narrative correspondence. It supports the tradition, not identity of Latin recension. |
