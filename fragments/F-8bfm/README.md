...
|---|---|
| `image-001.png`; `c1_lo_s01.jpg`–`c1_lo_s03.jpg` | Initial four-row crop and surrounding argument about acquired and theological virtues; Aristotle; assent, love, hope, and infused habits |
...
- [n40, left column](https://archive.org/details/A336075/page/n40/mode/1up), crops `p40_a1.jpg` and `p40_a2.jpg`: end of Lectio II, theological virtues and objections.
...
Rows count physical text rows from each crop's top, including clipped rows. Parentheses propose abbreviation expansions; `?` marks doubt; `[illegible]` leaves unresolved image text. The full assisted record gives additional scoped rows and the actual exposure inventory.

The original packet `image-001.png`, also visible at the top of `c1_lo_s02.jpg`:

```text
1  [cropped; illegible]
2  atitudine(m) determinat sufficient(er)? ar(istoteles) in mo-
3  ralibus suis. sed non facit mencio(n)e(m)
...
```text
1  sentire hiis que fides p(re)dicat de deo si
2  b(e)n(e) instruat(ur). Si(mili)ter deu(m) cognitu(m) p(otest) amare
3  sup(er) omnia et sperare q(uod) ille deus dabit
4  sibi vita(m) immortalem. Ergo ad ipsos? ac-
5  tus non est necesse ponere h(ab)itus infusos
```

From `c3_lo_s00.jpg` and `c3_lo_s01.jpg`, back-cover lower band:

```text
c3_lo_s00:3  Et ideo ad istam consequenda(m) oportet
c3_lo_s00:4  q(uod) homini sup(er)addant(ur) virtutes theologice
c3_lo_s00:5  que ideo theologice dicu(n)t(ur) quia a solo
c3_lo_s01:1  deo nobis infundunt(ur) [illegible] sola diuina relacio(n)e?
c3_lo_s01:2  in sola sacra scriptura nobis tradunt(ur).
```

From `c3_lo_s03.jpg` and `c3_lo_s04.jpg`:

```text
c3_lo_s03:3  meritoriam in p(rese)nti. s(cilicet) Rectitudo s(an)c(t)e co(n)-
c3_lo_s03:4  versacionis. ibi. in simplicitate. Gratitudo
c3_lo_s03:5  pie deuocionis. ibi. cordis. Sollicitu-
c3_lo_s03:6  do discrete inquisicionis. ibi. querite. [bottom clipped]
c3_lo_s04:2  Altitudo quiete co(n)templacionis. ibi. illum.
c3_lo_s04:3  Circa primum notandum q(uod) simplicitas ista
c3_lo_s04:4  debet esse cum prudencia. sicut dicitur Mt. x.
```

Row 1 of `c3_lo_s04` repeats the preceding *do discrete inquisicionis* row and is not counted again. The manuscript's repeated *ibi* is visible; it has not been supplied from print.

## Diagnostic comparison and variants

| Passage | Agreement with the 1494 print and limits |
|---|---|
| Front-cover lower band, `c1_lo_s01`–`03`; n40 left | The question about theological virtues beyond acquired moral virtues is followed by Aristotle's account of happiness, then natural assent to faith's teaching, love of God, hope of immortal life, and the objection to positing infused habits. The extended wording and argumentative sequence agree. The manuscript begins *Dubium est hic utrum*, while print gives *Primo potest esse dubium hic utrum*. Print puts *Aristoteles* before *sufficienter*; the manuscript appears to reverse the order. Manuscript *ille deus dabit* corresponds to print *deus dabit*. |
